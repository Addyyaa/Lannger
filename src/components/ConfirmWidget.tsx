...
export default function ConfirmWidget({
  ...
  const disabledStyles: React.CSSProperties = confirmDisabled
    ...
    : {};
  return createPortal(
    <div data-test-id="confirm-widget-div-test-2" style={Container}>
      <div
        data-test-id="confirm-widget-div-test-1"
        style={{ ...confirmWidgetStyle(isDark, isPortrait), ...containerStyle }}
        data-testid="confirm-widget"
      >
        ...
        <h1
          data-test-id="confirm-widget-h1-test"
          style={{ ...titleStyleInner(isDark, isPortrait), ...titleStyle }}
          data-testid="confirm-widget-title"
        >
          {title}
        </h1>
        <p
          data-test-id="confirm-widget-p-test"
          style={{ ...messageStyleInner(isPortrait), ...messageStyle }}
          data-testid="confirm-widget-message"
        >
          {message}
        </p>
        <div
          data-test-id="confirm-widget-div-test"
          style={{
            display: "flex",
        ...
        >
          <button
            data-test-id="confirm-widget-button-test-1"
            style={{
              ...confirmButtonStyleInner(isDark, isPortrait),
              ...confirmButtonStyle,
              ...disabledStyles,
            }}
          ...
          <button
            data-test-id="confirm-widget-button-test"
            style={{
              ...cancelButtonStyleInner(isDark, isPortrait),
              ...cancelButtonStyle,
            }}
            onClick={onCancel}
            onMouseEnter={(e) => {
...
const confirmWidgetStyle = (
  isDark: boolean,
  isPortrait: boolean
): React.CSSProperties => ({
  width: isPortrait ? "90%" : "30%",
  maxWidth: isPortrait ? "90%" : "500px",
  ...
  boxShadow: isDark
    ? isPortrait
      ? "0 0 2.5vw 0 rgba(0, 0, 0, 0.3)"
      : "0 0 0.625vw 0 rgba(0, 0, 0, 0.3)"
    : isPortrait
    ? "0 0 2.5vw 0 rgba(0, 0, 0, 0.1)"
    : "0 0 0.625vw 0 rgba(0, 0, 0, 0.1)",
