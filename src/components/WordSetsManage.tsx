...
export default function WordSetsManage({
  manageReducer,
  setWordSets,
  wordSets,
}: WordSetsManageProps) {
  ...
  return (
    <>
      ...
      <div
        ...
        style={cardStyle}
        data-testid="word-sets-manage-card"
      >
        <div data-test-id="div-test-3" style={headerRowStyle}>
          ...
          <div data-test-id="div-test-2" style={versionContainerStyle}>
            <button
              ...
              onClick={versionBadgeClick}
            >
              {t("currentVersion", { version: APP_VERSION })}
            </button>
            <span data-test-id="span-test" style={buildInfoStyle}>
              {t("buildTime", { time: buildTimeDisplay })}
            </span>
          </div>
        </div>
      ...
      <WordSetsTable
        data-test-id="wordsetstable-test"
        wordSets={wordSets}
        loading={loading}
