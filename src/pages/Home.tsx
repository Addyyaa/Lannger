...
export default function Home() {
  const [learnningProgress, setLearnningProgress] = useState<{
  ...
  const [dailyLearningPlan] = useState<{
    totalVocabulary: number;
    masteredVocabulary: number;
    totalSentences: number;
    masteredSentences: number;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-testid="today-progress-vocabulary-containner"
        className={styles.todayProgress}
      >
        <p data-test-id="p-test-1">
          {t("todayLearningPlan", {
            totalVocabulary: learnningProgress.totalVocabulary,
            masteredVocabulary: dailyLearningPlan.masteredVocabulary,
          })}
        </p>
        <p data-test-id="p-test">
          {t("currentTheme", {
